...
export default function ResumeProjects({projects}: ProjectsProp) {
    return(
        <div className="py-2">
            <span className="text-2xl uppercase resume-header">Projects</span>
            <hr/>
            <div>
                {
                    projects.map((project: Project, index: number)=>(
                        <div key={index}>
                            ...
                            <div>
                                <ul key={index} className="list-inside list-disc text-sm text-center sm:text-left resume-desc">
